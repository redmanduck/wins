...
class Global {
 ...
 public:
  ...
  static double IMU_R;
  static double IMU_QD;
  static double IMU_QV;
  static double IMU_QA;
  static double IMU_ACC_SCALE;
  static double IMU_X_Correction;
  static double IMU_Y_Correction;
  static double IMU_Z_Correction;
  static double IMU_DELTA_T;
