...
int main (void)
{
    ...
    while (1) {
        ...
        if(!PORTDbits.RD13){
            ...
            LATAbits.LATA5 = 1;
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_H , &spiBufT[0], 1);
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_L , &spiBufT[1], 1);
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_H , &spiBufT[2], 1);
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_L , &spiBufT[3], 1);
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_H , &spiBufT[4], 1);
            LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_L , &spiBufT[5], 1);
        }
